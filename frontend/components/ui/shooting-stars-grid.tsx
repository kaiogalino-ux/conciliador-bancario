...
export function ShootingStarsGrid({
  ...
  return (
    <section
      ...
      className={cn(
        "group/shooting-stars relative isolate min-h-[520px] w-full overflow-hidden rounded-[2rem] border border-zinc-200 bg-zinc-50 text-zinc-950 shadow-2xl shadow-cyan-950/5 dark:border-white/10 dark:text-white dark:shadow-cyan-950/20",
        "bg-[linear-gradient(180deg,#f8fbff_0%,#eaf4ff_52%,#f8fbff_100%)] dark:bg-[linear-gradient(180deg,#07090f_0%,#0b1020_55%,#07090f_100%)]",
        className,
      )}
      style={
        {
